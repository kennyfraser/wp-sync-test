...
**Prerequisite:** If your SSH key has a passphrase, you must [decrypt][3] before installing DCOS.
...
3.  Move your private RSA key to `genconf/ssh_key`. For more information, see the [ssh_key_path][3] parameter.
