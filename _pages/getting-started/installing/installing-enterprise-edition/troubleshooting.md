...
<p>Here is the sequence in which DCOS components come online. <!-- Add example of clusters converging and show logs with ignorable errors; clean logs. Examples of common failures are harder to show, because this would be a bug. --></p>
