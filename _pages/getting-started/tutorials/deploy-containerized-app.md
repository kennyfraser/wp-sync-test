...
layout: page
permalink: >
  https://dev-mesosphere-documentation.pantheonsite.io/getting-started/tutorials/deploying-a-containerized-app-on-a-public-node/
published: true
import_src:
  - >
...
4.  You can scale Oinker back up to 4 instances with this command:
 ...
 [6]: ../administration/universe/#scrollNav-2
