...
layout: page
permalink: >
  https://docs.mesosphere.com/installing-enterprise-edition-1-5/step-2-cluster-prerequisites/
published: true
header_0_background:
  - fill
...
Docker version 1.9 or greater must be installed on your workstation and cluster nodes. You must run Docker commands as the root user (`sudo`). For more information, see [Docker installation][3].
