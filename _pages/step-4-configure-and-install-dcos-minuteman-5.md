...
author: Joel Hamill
post_date: 2016-02-12 06:39:03
post_excerpt: ""
layout: page
permalink: >
  http://local.mesodocs.com/step-4-configure-and-install-dcos-minuteman-5/
published: true
...
3.  Run this command to generate your customized DCOS build file:
    ...
    **Tip:** For the install script to work, you must have created `genconf/config.yaml` and [genconf/ip-detect][8].
